...
# List of devices, each device defined as a dictionary, could include any cisco ios device routers and switches
...
for device in devices: 
    try:
        ...
        # ** followed by the dictionary name, or in our case devices = r1, r2, etc, the name of each 
