...
# List as a docstring - a list that is encapsulated in triple quotes.
# The splitlines() method splits a string into a list. The splitting is done at line breaks.
# strip() method removes spaces at the beginning and end of the string 
# devices = '''
# 192.168.1.1
# 192.168.2.2
# 192.168.3.2
...
devices = ['192.168.1.1',  '192.168.2.2', '192.168.99.99', '192.168.3.2']
